...
describe('Red Hat OpenShift Dev Spaces helper', () => {
  describe('cheURL', () => {
    fancy
    ...
    fancy
      ...
      .it('computes Red Hat OpenShift Dev Spaces URL on K8s', async () => {
    ...
    fancy
      ...
      .it('fails fetching Red Hat OpenShift Dev Spaces URL when ingress does not exist')
    fancy
      .stub(kube, 'getNamespace', () => ({}))
      .stub(kube, 'isIngressExist', () => false)
      .stub(kube, 'isOpenShift', () => false)
    ...
    fancy
      ...
      .it('fails fetching Red Hat OpenShift Dev Spaces URL when route does not exist')
    fancy
      .stub(kube, 'getNamespace', () => undefined)
      .do(() => ch.cheURL('che-namespace'))
      .catch(err => expect(err.message).to.match(/ERR_NAMESPACE_NO_EXIST/))
      .it('fails fetching Red Hat OpenShift Dev Spaces URL when namespace does not exist')
  })
