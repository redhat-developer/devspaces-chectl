...
export class OperatorInstaller implements Installer {
  ...
  private static readonly OPERATOR_SERVICE = 'devspaces-operator-service'
  private static readonly OPERATOR_SERVICE_CERT = 'devspaces-operator-webhook-server-cert'
  private static readonly CERTIFICATE = 'devspaces-operator-serving-cert'
  private static readonly ISSUER = 'devspaces-operator-selfsigned-issuer'
  private static readonly SERVICE_ACCOUNT = 'devspaces-operator'
        ...
        task: async (ctx: any, task: any) => {
          try {
            if (ctx[ChectlContext.IS_OPENSHIFT]) {
              ...
              await kh.deleteRole('devspaces-operator', this.flags.chenamespace)
              await kh.deleteRole('devspaces-operator-leader-election', this.flags.chenamespace)
              await kh.deleteRoleBinding('devspaces-operator', this.flags.chenamespace)
              await kh.deleteRoleBinding('devspaces-operator-leader-election', this.flags.chenamespace)
              await kh.deleteClusterRole(`${this.flags.chenamespace}-devspaces-operator`)
              await kh.deleteClusterRoleBinding(`${this.flags.chenamespace}-devspaces-operator`)
