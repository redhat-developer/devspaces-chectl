...
export namespace EclipseChe {
  ...
  // Doc links
  export const DOC_LINK = 'https://access.redhat.com/documentation/en-us/red_hat_openshift_dev_spaces/3.5/'
  export const DOC_LINK_RELEASE_NOTES = 'https://access.redhat.com/documentation/en-us/red_hat_openshift_dev_spaces/3.5/html/release_notes_and_known_issues/index'
  ...
  export const POSTGRES_DEPLOYMENT_NAME = 'postgres'
  ...
  export const POSTGRES_SELECTOR = `app.kubernetes.io/name=${CHE_FLAVOR},app.kubernetes.io/component=postgres`
