...
function ensureOIDCProviderInstalled(flags: any): Listr.ListrTask {
  return {
    ...
    task: async (_ctx: any, task: any) => {
      ...
      throw new Error('OIDC Provider is not installed in order to deploy CodeReady Workspaces. To bypass OIDC Provider check use \'--skip-oidc-provider-check\' flag')
    },
  }
}
