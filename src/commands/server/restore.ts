...
export default class Restore extends Command {
  static description = 'Restore CodeReady Workspaces installation'
  ...
  static examples = [
    ...
    'crwctl server:restore -r rest:http://my-sert-server.net:4000/che-backup -p repopassword --version=7.35.2 --snapshot-id=9ea02f58',
  ...
  static flags: flags.Input<any> = {
    ...
    rollback: boolean({
      description: 'Rolling back to previous version of CodeReady Workspaces only if backup exists',
      required: false,
  ...
  private getRestoreTasks(flags: any): Listr.ListrTask[] {
    ...
    return [
      ...
      {
        title: 'Uninstall CodeReady Workspaces operator',
